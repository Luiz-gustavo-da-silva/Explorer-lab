...
const cardNumberPattern = {
  ...
  dispatch: function (appended, dynamicMasked) {
    ...
    const fundMask = dynamicMasked.compiledMasks.find(function (item) {
...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerHTML =
    cardHolder.value.length === 0 ? "FULANO DE TAL DA SILVA" : cardHolder.value
})
